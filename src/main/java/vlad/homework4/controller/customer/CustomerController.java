...
import vlad.homework4.DTO.customer.listCustomerDto;
import vlad.homework4.domain.Customer;
import vlad.homework4.facade.CustomerFacade;
...
//        Page<Customer> custPage = customerService.getPagedAll(pageNumber, pageSize);
    ...
    public List<CustomerResponseDto> findAll() {
        ...
        System.out.println("@GetMapping(\"/customers/all\")-> CustomerResponseDto: " + cRsDto);
        return cRsDto;
    }
